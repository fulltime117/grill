    ...
    <div class="col-xl-8 col-lg-6 col-md-7 col-sm-12 layout-top-spacing">
            ...
            <div class="widget-content widget-content-area">
                ...
                @forelse($user->userCourses as $course)
                    ...
                    <div class="progress br-30">
                        <div class="progress-bar bg-primary @if($course->pivot->end_date) bg-warning @endif" 
                            role="progressbar" 
                            ...
                            <div class="progress-title">
                                ...
                                <a href="{{ route('admin.lessons.show', $current_lesson->id) }}" class="bs-tooltip" title="{{ $current_lesson->lesson_name }}">
                                    ...
                                    @else
                                        <span class="text-white"> Congratulations! You are finished this course </span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ff0000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bookmark"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path></svg>
                                    @endif
                            </div>
        ...
        <div class="bio layout-spacing">
            <div class="widget-content widget-content-area pb-4">
                ...
                <div class="mt-2">
                    {{--<img class="border" src="{{ $user->profile->sign_data ?? '/assets/img/200x200.jpg'}}" width="100%">--}}
                </div>                
            </div>                                
        </div>
