...
<body class="coming-soon">    
    ...
    <div class="coming-soon-container">
        <div class="coming-soon-cont position-relative">
            <div class="absolute p-4">
                <img src="assets/img/gold-logo.svg" alt="logo" width="120px">
            </div>
            <div class="coming-soon-wrap" style="">
                <div class="coming-soon-container">
                    <div class="coming-soon-content">

                        <h4 class="">Coming Soon</h4>
                        <p class=""> נהיה כאן עוד מעט זמן ..... </p>
                        ...
                        <p class="terms-conditions">© 2021 All Rights Reserved. <a href="index.html">Grillman</a> is a product of Designreset. <a href="javascript:void(0);">Cookie Preferences</a>, <a href="javascript:void(0);">Privacy</a>, and <a href="javascript:void(0);">Terms</a>.</p>
    ...
    <script>
        ...
        var countDownDate = new Date("Apr 19, "+ getYear +" 15:37:25").getTime();
