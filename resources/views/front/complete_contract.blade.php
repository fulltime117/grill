...
<head>
    ...
    <style>
        ...
        .checkmark .star:nth-child(1) {
        width: 12px;
        height: 12px;
        left: 12px;
        top: 16px;
        }
        .checkmark .star:nth-child(2) {
        width: 18px;
        height: 18px;
        left: 168px;
        top: 84px;
        }
        .checkmark .star:nth-child(3) {
        width: 10px;
        height: 10px;
        left: 32px;
        top: 162px;
        }
        .checkmark .star:nth-child(4) {
        width: 20px;
        height: 20px;
        left: 82px;
        top: -12px;
        }
        .checkmark .star:nth-child(5) {
        width: 14px;
        height: 14px;
        left: 125px;
        top: 162px;
        }
        .checkmark .star:nth-child(6) {
        width: 10px;
        height: 10px;
        left: 16px;
        top: 16px;
...
<body>
    <section style="direction: rtl; text-align: right;" class="complete-contract-page-area">
        
        <div class="container">
            <div class="complete-contrac-content">                 
                <div class="success-content">
                    ...
                    <div class="succeess-page-text">
                        <h3 style="color:#383838"> ברכות לרגל הצטרפותך! פרטי הגישה נשלחו אליך למייל, בהצלחה! </h3>
                    </div>

                    <div class="succeess-page-login">
                        @guest
                            <a href="{{ route('login') }}" class="btn"> התחברות </a>
                        @endguest
                        
                        @auth
                            <a href="{{ route('client.courses', auth()->user()) }}" class="btn"> הקורסים שלי </a>
                        @endauth
                    </div>
                </div>
            </div>
