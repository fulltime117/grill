...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active"><a href="{{ route('admin.courses') }}"> {{$course->course_name}} </a> </li>
...
@section('content')
    ...
    <div class="row layout-top-spacing">
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <form id="add_course_form" action="{{ route('admin.courses.update', $course) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="form-row mb-4">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="statbox widget box box-shadow mb-4">
                            ...
                            <div class="widget-content widget-content-area">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('course_name') border-danger @enderror" id="course_name" name="course_name" placeholder="Please Input course_name" value="{{ old('course_name') ?? $course->course_name }}">
                                    @error('course_name')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="number" class="form-control @error('overview') border-danger @enderror" id="overview" name="overview" placeholder="Please Input overview" >{{ old('overview') ?? $course->overview }}</textarea>
                                    @error('overview')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{$message}}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('course_price') border-danger @enderror" id="course_price" name="course_price" placeholder="Please Input course_price" value="{{ old('course_price') ?? $course->course_price }}">
                                    @error('course_price')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{$message}}
                                        </div>
                        ...
                        <div id="cover_image" class="statbox widget box box-shadow mb-4">
                            <div class="widget-header">
                                <div class="row">
                                    <div class="">
                                ...
                                <div class="custom-file-container" data-upload-id="myFirstImage">
                                    ...
                                    <div class="custom-file-container__image-preview position-relative">
                                        <div class="bg-white position-absolute media-image">
                                            <img src="{{ asset($course->cover_image)}}" width="100%" alt=""> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="fuSingleFile" class="col-md-6 mb-4">
                            ...
                            <div class="widget-content widget-content-area">
                                <div class="form-group">
                                    <select name="type" id="type" class="form-control selectpicker @error('type') border-danger @enderror" value="old('type')">
                                        <option @if( old('type') == 'image' || $course->type == 'image' ) selected  @endif data-content="<span class='badge badge-primary'>Image</span>">image</option>
                                        <option @if( old('type') == 'video' || $course->type == 'video' ) selected  @endif  data-content="<span class='badge badge-dark'>Video</span>">video</option>
                                        <option @if( old('type') == 'vimeo' || $course->type == 'vimeo' ) selected  @endif data-content="<span class='badge badge-danger'>Vimeo</span>">vimeo</option>
                                    </select>
                                    @error('type')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{$message}}
                        ...
                        <div id="select_media" class="statbox widget box box-shadow allmedia mb-4
                            @if( old('type') == 'vimeo' || $course->type == 'vimeo' ) d-none @endif
                            ">
                                ...
                                <div class="custom-file-container position-relative" data-upload-id="myFirstImage2">
                                    ...
                                    <div class="custom-file-container__image-preview position-relative">
                                        @if($course->type == 'image')
                                            <div class="bg-white position-absolute media-image">
                                                <img src="{{ asset($course->media)}}" width="100%" alt=""> 
                                            </div>
                                        @endif
                        ...
                        <div id="select_vimeo" class="statbox widget box box-shadow allmedia mb-4
                            @if( old('type') != 'vimeo' && $course->type != 'vimeo' ) d-none @endif
                            ">
                            ...
                            <div class="widget-content widget-content-area">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="vimeo" class="form-control @error('vimeo') border-danger @enderror"" placeholder="https://vimeo.com" 
                                        @if( $course->type == 'vimeo') value="{{ old('vimeo') ??  $course->media }}" @endif>
                                        @error('vimeo')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{$message}}
                                        </div>
                                ...
                                @if($course->type == 'vimeo' && $course->media)
                        ...
                        <div class="statbox widget box box-shadow mb-4">
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <textarea class="d-none" name="body" id="body" cols="30" rows="10">{{ $course->body }}</textarea>
                                
                                
                                <div class="col-md-12 mt-4">
                                    <button type="submit" id="add_course" class="btn btn-primary mt-3">Update Course</button>
                                </div>
                            </div>
                        </div>
