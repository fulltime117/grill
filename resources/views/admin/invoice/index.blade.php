...
@section('page-styles')
    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/apps/invoice.css')}}">
@endsection

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="javascript:void(0);">Apps</a></li>
    <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);">Invoice List</a></li>
@endsection
                                ...
                                <div class="content-section  animated animatedFadeInUp fadeInUp">
                                    ...
                                    <div class="row inv--head-section">
                                        ...
                                        <div class="col-sm-6 col-12 align-self-center text-sm-right">
                                            <div class="company-info">
                                                <img class="rounded-circle mx-3" src="{{ asset('assets/img/cow.png') }}" width="50px">
                                                <h5 class="inv-brand-name">Grillman</h5>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row inv--detail-section">
                                        ...
                                        <div class="col-sm-5 align-self-center  text-sm-right order-sm-0 order-1">
                                            <p class="inv-detail-title">From : Grillman Corporation</p>
                                        </div>
                                                ...
                                                <table class="table">
                                                    <thead class="">
                                                        <tr>
                                                            ...
                                                            <th class="text-right" scope="col">Lessons Number</th>
                                                            <th class="text-right" scope="col">Course Price</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
                                                            <td>1</td>
                                                            <td>Grilman course 1</td>
                                                            <td class="text-right">20</td>
                                                            <td class="text-right">₪3000</td>
                                                        </tr>
                                                        <tr>
                                                            <td>2</td>
                                                            <td>Grillman course 2</td>
