...
@section('page-title')
    <title>Admin - My Calendar</title>
@endsection


@section('page-styles')
    <link rel="stylesheet" type="text/css" href="{{asset('plugins/fullcalendar/fullcalendar.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('plugins/fullcalendar/custom-fullcalendar.advance.css')}}">
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);">My Calendar</a></li>
@endsection
