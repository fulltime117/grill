                            ...
                            @if(isset($sales))
                                @foreach ($sales as $sale)
                                    <tr>
                                        ...
                                        <td>{{ $sale->discount }}</td>
                                        <td>
                                            @forelse ($sale->courses as $course)
                                                <div class="d-flex align-items-center">
                                                    <a href="{{ route('admin.courses.show', $course) }}">
                                                        <p class="align-self-center mb-0 admin-name"> {{ $course->course_name }} {{ $course->course_price }}</p>
                                                    </a>
                                                </div>
                                            @empty
                                                -
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center" style="width:80px">
                                                <a href="{{ route('sales.ajax_course', $coupon) }}" 
                                                    class="open-addusers" 
                                                    data-url="{{ route('sales.', $coupon) }}" 
                                                    data-toggle="modal" 
                                                ...
                                                <a href="javascript:void(0);" class="open-edit" 
                                                    ...
                                                    data-body="{{ $coupon->body }}"
                                                    data-discount="{{ $coupon->discount }}"
                                                    data-expired="{{ $coupon->expired }}"
                                                    data-url="{{ route('sales.update', $coupon) }}" 
                                                    data-toggle="modal" 
                                                    data-target="#editCoupanModal">
                                                    <i class="far fa-edit text-primary"></i>
                                                </a>
                                                
                                                <form action="{{ route('sales.delete', $coupon) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content" >
                <div class="modal-body" >
                    ...
                    <div class="compose-box">
                        <div class="compose-content" id="addUserModalTitle">
                            <h5 class="">Add Courses</h5>
                            <form id="add-courses-form" action="" method="post">
                ...
                <div class="modal-footer">
                    ...
                    <button id="add-users" class="btn btn-success ">Add Courses</button>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex mail-to mb-4">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text flaticon-menu-list"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                                            <div class="w-100">
                                                <textarea type="text" class="form-control" name="body">comment
                                                </textarea>
                                            </div>
                                        </div>
                                    </div>
