...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);">Post Page</a></li>
...
@section('content')
    ...
    <div class="row layout-top-spacing">
        ...
        <div class=" col-lg-10 offset-lg-1  layout-spacing">
            <form id="edit_aboutus_form" action="{{ route('admin.banners.post.update') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <input type="hidden" name="id" value="{{$post_page->id}}">
                    ...
                    <div class="p-4 mb-4 mt-4">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-12 text-center mt-4 mb-5">
                                <h5>Banner image</h5>
                                <label for="banner">
                                    <img id="banner_img"src="{{ asset($post_page->banner) }}" width="100%" style="cursor: pointer">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">                                
                                    ...
                                    <input type="text" name="title" class="form-control" id="banner_title" value="{{$post_page->title}}"/>
                                </div>
                            </div>
