...
@section('page-title')
    <title>Admin - Contact Hisotry</title>
@endsection
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page"><span>lessons List</span></li>
@endsection
                            ...
                            <div class="item-content">
                                <div class="user-profile">
                                    ...
                                    <div class="user-meta-info">
                                        <p class="user-name" data-name="Alan Green">{{ $user->firstname }} {{ $user->lastname }}</p>
                                        <p class="user-work" data-occupation="Web Developer">{{ $user->identity }}</p>
                                    </div>
                                </div>
                                <div class="user-email">
                                ...
                                <div class="user-location">
                                    ...
                                    <p class="usr-location" data-location="{{ $user->address }}">{{ $user->address }}</p>
                                </div>
                                <div class="user-phone">
                                    <p class="info-title">Phone: </p>
                                    <p class="usr-ph-no" data-phone="{{ $user->phone }}">{{ $user->phone }}</p>
                                </div>
                                <div class="action-btn">
